...
const App: Component = () => {
  return (
    <div class={`h-screen flex flex-col ${themeClasses.bg()}`}>
      {/* Header */}
      <header class={`${themeClasses.bgSecondary()} border-b ${themeClasses.border()} backdrop-blur-sm`}>
        <div class="px-6 py-4">
          <div class="flex items-center justify-between">
            ...
            <div class="flex items-center space-x-2">
              ...
              {/* Settings */}
              <button class={`p-2 ${themeClasses.textMuted()} ${themeClasses.hover()} rounded-lg transition-all duration-200 hover:${themeClasses.textSecondary()}`}>
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
